...
2. A small camera (cystoscope) is placed into the urethra so we can see the injection sites
3. The bulking agent is injected at specific points around the urethra until the opening looks well sealed
4. The whole procedure takes about 15 minutes
