...
faq:
  ...
  - question: "Can I have a sling if bulking agents don't work?"
    answer: "Yes. Having bulking injections first does not take a sling off the table later. A sling can be placed safely after prior bulking."
  - question: "How many bulking agent injections will I need?"
    answer: "Some women do well after one injection; others need a repeat to get the result they want. Repeat injections are common and can be done in the office as needed."
  - question: "Is the sling mesh the same as the mesh used for prolapse?"
    answer: "No. The midurethral sling is a narrow tape placed under the urethra. It is not the larger transvaginal mesh sheets for prolapse that the FDA removed from the market in 2019."
---
